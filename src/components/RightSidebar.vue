<template>
  <div
    class="w-[318px] bg-inputBg border-2 border-[#075985] rounded-2xl h-[570px] overflow-hidden hover:overflow-y-auto hover:overflow-x-hidden flex flex-col items-center justify-start gap-8 relative p-4"
  >
    <div
