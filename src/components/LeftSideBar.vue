<template>
  ...
  >
    ...
    <div
      class="w-full flex items-center justify-center py-2 hover:bg-sidebarhoverColor transition-all duration-300 cursor-pointer rounded-md"
    >
      <img src="../assets/icons/logOutIcon.png" alt="icons" />
    </div>
  </div>
</template>
